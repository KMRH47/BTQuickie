...
public static class ScreenHelper
{
  ...
  ///   </b>
  /// </returns>
  public static (double, double) GetScaledScreenSize(Window window, bool ignoreTaskbar = false,
    bool useScreenFromCursorPos = false) {
    ...
    var scaledWidth = (int)Math.Round(screenX / dpiScale.DpiScaleX);
    var scaledHeight = (int)Math.Round(screenY / dpiScale.DpiScaleY);
