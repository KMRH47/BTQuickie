...
internal static class WindowExtensions
{
  ...
  /// <summary>
  ///   Unmanaged function call
  ///   <a href="https://docs.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-getwindowlonga">GetWindowLong</a>.
  /// </summary>
  ...
  /// <summary>
  ///   Unmanaged function call
  ///   <a href="https://docs.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-setwindowlonga">SetWindowLong</a>.
  /// </summary>
  [DllImport("user32.dll")]
  ...
  public static void ShowBottomRightCorner(this Window window) {
    (double width, double height) =
      ScreenHelper.GetScaledScreenSize(window, true, true);
  ...
  /// </summary>
  /// <remarks>
  ///   A <b>Handle to a WiNDow</b> (HWND) is automatically created when a window is shown/rendered within the WPF ecosystem.
  ///   <br /><br />
