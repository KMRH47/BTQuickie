...
public static class KeyEventArgsExtensions
{
    ...
    /// </summary>
    /// <returns>True if the key is a <see cref="System.Windows.Input.ModifierKeys">modifier key</see>
    ...
    /// </summary>
    /// <returns>Returns the <see cref="System.Windows.Input.ModifierKeys">modifier keys</see> currently pressed
    /// (including <see cref="System.Windows.Input.ModifierKeys.Windows"/>).</returns>
